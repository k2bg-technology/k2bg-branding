...
import { BlockWipe } from '../../primitives/BlockWipe';
...
export function BlockWipeDemo() {
  ...
  return (
    <AbsoluteFill className="bg-base-black">
      {/* The photo underlay proves both coverage endpoints reveal the scene. */}
      <Img
        src={SAMPLE_IMAGE_SOURCE}
        className="absolute inset-0 h-full w-full object-cover"
      />
      <BlockWipe coverage={coverage} />
    </AbsoluteFill>
  );
}
