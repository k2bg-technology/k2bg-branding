...
export default function Page() {
  return (
    <div className="grid absolute top-1/2 auto-rows-min gap-2 -translate-y-1/2 px-20">
      <main>
        <div className="grid grid-flow-col auto-cols-max rounded-3xl shadow-2xl h-[60rem] overflow-hidden">
          {/* HERO */}
          <section>
            <div className="flex h-full">
              <div className="relative w-[35rem] h-full">
                <Image
                  src="/hero.jpg"
                  fill={true}
                  alt="Hero Image"
